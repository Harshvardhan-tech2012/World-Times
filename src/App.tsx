          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold uppercase tracking-widest text-black/40">
                {searchQuery ? `Search Results: ${searchQuery}` : `${category} News`}
              </h2>
            </div>
          </div>
      ...
      <footer className="bg-white border-t border-black/5 py-12">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-black/40 leading-relaxed">
              Built with React, Tailwind, and Gemini AI. News provided by GNews.
            </p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 mt-12 pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-[10px] text-black/20 font-bold uppercase tracking-widest hover:text-black transition-colors">Privacy</a>
            <a href="#" className="text-[10px] text-black/20 font-bold uppercase tracking-widest hover:text-black transition-colors">Terms</a>
            <a href="#" className="text-[10px] text-black/20 font-bold uppercase tracking-widest hover:text-black transition-colors">Contact</a>
          </div>
        </div>
      </footer>
    </div>
